...
**1.3 Make the color of all points in the prvious plot red.**
```{r}
## Write your code here
```
...
**1.13  You have now created a cariety of dfferent plots of the same dataset. Which of your plots do you think are the most informative? Describe briefly the major trends that you see in the data**
